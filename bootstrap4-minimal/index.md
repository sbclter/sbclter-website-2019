...
window.setTimeout(function(){
    $(".twitter-timeline").contents().find(".timeline-Tweet-text").css("font-size","16");
}, 1000);
</script>
...
<!-- how to set cols: pages can vary the col widths; for full-width total should = 12. 
   ...
   <a href="https://twitter.com/LterSbc" target="_blank"><img src="/assets/img/twitter.png" alt="Twitter" width="70" height="70"></a>
    ...
    <a class="twitter-timeline" data-height="800" data-theme="light" href="https://twitter.com/LterSbc?ref_src=twsrc%5Etfw">Tweets by LterSbc</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
