...
.recent-paper-image img {
  height: 100%;
  object-fit: contain;
  width: 100%;
}

.recent-paper-card .card-body {
  background: #fff;
}

.recent-paper-card .card-title {
  line-height: 1.4;
}
</style>
...
<h2 class="mb-4">SBC LTER Overview</h2>
<center>
...
<hr>
<br>
<h2 class="mb-4">Recent Research Findings</h2>
<div class="row text-center mb-4">
  {% for paper in site.data.recent_papers %}
  <div class="col-sm-6 col-lg-3 mb-4">
    <article class="card h-100 border-0 shadow-sm recent-paper-card">
      <div class="recent-paper-image">
        <a href="{{ paper.doi }}" target="_blank" rel="noopener noreferrer">
          <img src="{{ site.baseurl }}{{ paper.picture }}" alt="Figure from {{ paper.title }}">
        </a>
      </div>
      <div class="card-body d-flex flex-column">
        <h6 class="card-title font-weight-bold">{{ paper.title }}</h6>
        <a class="btn btn-sm btn-outline-primary mt-auto align-self-center" href="{{ paper.doi }}" target="_blank" rel="noopener noreferrer">View Paper</a>
      </div>
    </article>
  </div>
  {% endfor %}
...
<div class="text-center mb-5">
  <a class="btn btn-primary" href="{{ site.baseurl }}/publications/">View SBC Bibliography</a>
</div>
...
<h2 class="mb-4">SBC LTER News</h2>
<div class='container'>
