...
<p>An SBC user can <a href="{{site.baseurl}}/external/Documents/data_help/SBC_map_network_drive.pdf">map SBC file server</a> on your computer, which allows you to view all SBC related documents, pictures, data, collaborated projects as 
...
(<a href="https://www.it.ucsb.edu/get-connected-vpn">UCSB VPN</a>) can map the SBC server. 
 ...
 <p> Internal data access requires an SBC server account in the GRIT system. Usually an investigator or staff member requests the account for new students, staff or associate investigators. Those requesting the login account should contact <a href="/about/people/lkui/">Li Kui</a> (SBC's information manager), and provide the new participant's name, email address and advisor's name.</p>
<p>If you have an active account in the GRIT system, you can find the password setup/reset portal on the <a href="https://selfservice.grit.ucsb.edu/">self-service page</a>. </p> 

 <hr/>
 <h4>Data management plan</h4>
<p>Within the LTER community, data management plans have been a requirement, and generally, the LTER Network is a leader in data management practices for diverse environmental data. If you plan to collaborate with SBC and house your data in the SBC system, please contact <a href="mailto:lkui@ucsb.edu">SBC information manager</a> and discuss your proposal's progress. </p> 
