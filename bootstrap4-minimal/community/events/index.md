...
<div class="container mt-3">
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#current">Current News and Events</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#archive">Archived News and Events</a>
        </li>
    </ul>
    <div class="tab-content">
        <div id="current" class="container tab-pane active"><br>
            ...
            <div class="content-style">
               <ul>                   
                    <li><a href="https://news.ucsb.edu/2025/022023/kelp-forests-are-connected-local-beach-ecosystems" target="offline">2025-09-16 Kelp forests strongly influence nearby sandy beach ecosystems: beaches within ~10 km of kelp beds receive kelp wrack that supports food webs, especially in winter, highlighting the importance of conserving kelp for beach biodiversity and ecosystem function.</a></li>  
...
<p><a href="https://mailchi.mp/fe4c3b30996d/spring-summer-2025-updates-from-the-sbc-lter-6425924" target="_blank">SBCLTER News | Spring & Summer 2025</a></p>
...
<style>
      /* Custom CSS for header styling */
        .header-style {
            background-color: #f8f9fa; /* Light gray background similar to Bootstrap's default accordion header */
            padding: 10px 15px;
        ...
        .header-style:first-of-type {
            margin-top: 0; /* Removes top margin for the first header to align closely with tab change */
        }
        .content-style {
            padding: 15px;
        }
